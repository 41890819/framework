 ...
 * @hide
 */
public class IngenicVolumePanel extends Handler implements View.OnClickListener
{
    private static final String TAG = "IngenicVolumePanel";
    ...
    private static class WarningDialogReceiver extends BroadcastReceiver
        ...
        private final Dialog mDialog;
        private final IngenicVolumePanel mVolumePanel;

        WarningDialogReceiver(Context context, Dialog dialog, IngenicVolumePanel ingenicVolumePanel) {
            mContext = context;
            mDialog = dialog;
            mVolumePanel = ingenicVolumePanel;
    ...
    public IngenicVolumePanel(final Context context, AudioService volumeService) {
        mContext = context;
        ...
        View view = mView = inflater.inflate(R.layout.glass_volume_adjust, null);
	...
	mVolumeIcon = (ImageView) mView.findViewById(R.id.set_volume_icon);
	mTextViewGroup = (LinearLayout)mView.findViewById(R.id.textView_group);
	//mVolumeType = (TextView)mView.findViewById(R.id.volume_type);
        //mSliderGroup = (ViewGroup) mView.findViewById(R.id.slider_group);
        //mMoreButton = (ImageView) mView.findViewById(R.id.expand_button);
        //mDivider = (ImageView) mView.findViewById(R.id.expand_button_divider);
	// TextView box1 = (TextView)mView.findViewById(R.id.set_volume1);
	// TextView box2 = (TextView)mView.findViewById(R.id.set_volume2);
	// TextView box3 = (TextView)mView.findViewById(R.id.set_volume3);
	// TextView box4 = (TextView)mView.findViewById(R.id.set_volume4);
	// TextView box5 = (TextView)mView.findViewById(R.id.set_volume5);
	// TextView box6 = (TextView)mView.findViewById(R.id.set_volume6);
	// TextView box7 = (TextView)mView.findViewById(R.id.set_volume7);

	// //TextView boxs [] = {box1,box2,box3,box4,box5,box6,box7};
	// boxs = new TextView [7];
	// boxs[0] = box1;
	// boxs[1] = box2;
	// boxs[2] = box3;
	...
	// boxs[6] = box7;
        ...
        mPanel.getBackground().setAlpha(0);
	...
	final int gravity = Gravity.getAbsoluteGravity(Gravity.CENTER, config.getLayoutDirection());
	mParams.gravity = gravity;
        ...
        // lp.privateFlags |= WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE|WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE;
	...
	Log.d("zzzzzzz","---------createSliders");
	    ...
	    // TextView box1 = (TextView)sc.group.findViewById(R.id.set_volume1);
	    // TextView box2 = (TextView)sc.group.findViewById(R.id.set_volume2);
	    // TextView box3 = (TextView)sc.group.findViewById(R.id.set_volume3);
	    // TextView box4 = (TextView)sc.group.findViewById(R.id.set_volume4);
	    // TextView box5 = (TextView)sc.group.findViewById(R.id.set_volume5);
	    // TextView box6 = (TextView)sc.group.findViewById(R.id.set_volume6);
	    // TextView box7 = (TextView)sc.group.findViewById(R.id.set_volume7);
	    //sc.boxs = {box1,box2};
	   //  int a[] = {0,1,2,3,4};
	   //  TextView s[];
	   // TextView  s[] = {box1,box2};
	    // sc.boxs[0] = box1;
	    // sc.boxs[1] = box2;
	    // sc.boxs[2] = box3;
	    // sc.boxs[3] = box4;
	    ...
	    //sc.progress = (LinearLayout)sc.group.findViewById(R.id.progress);
	...
	Log.d("zzzzzzzz","postVolumeChanged");
	...
	Log.d("zzzzzzz","postRemoteVolumeChanged");
	...
	Log.d("zzzzzzz","postMasterMuteChanged:"+flags);
     ...
     */
    // private void setTextStreamType(int streamType){
    // 	switch (streamType){
    // 	case AudioManager.STREAM_ALARM:
    // 	    mVolumeType.setText(R.string.volume_alarm);
    // 	    break;
    // 	case AudioManager.STREAM_VOICE_CALL:
    // 	    mVolumeType.setText(R.string.volume_icon_description_incall);
    // 	    break;
    // 	case AudioManager.STREAM_RING:
    // 	    mVolumeType.setText(R.string.volume_icon_description_ringer);	    
    // 	    break;
    // 	case AudioManager.STREAM_MUSIC:
    // 	    mVolumeType.setText(R.string.volume_icon_description_media);	    
    // 	    break;
    // 	case AudioManager.STREAM_NOTIFICATION:
    // 	    mVolumeType.setText(R.string.volume_icon_description_notification);	    
    // 	    break;
    // 	default:
    // 	    mVolumeType.setText("unkonw");
    // 	    break;
    ...
    // }
    private void updateUI(int streamType,int currentVolume,int maxVolume){
	int textWidth = 0;
	int textHeight = 0;
    	if(currentVolume == 0)
    	    mVolumeIcon.setImageResource(R.drawable.volume_mute);
    	else
    	    mVolumeIcon.setImageResource(R.drawable.set_volume);
	//setTextStreamType(streamType);
	...
	if(streamType != mLastStreamType){
	    if(streamType != -1){
		mTextViewGroup.removeAllViews();
	    }
	    mLastStreamType = streamType;
	    boxs = new TextView [maxVolume];
	    for(int i =0; i<= maxVolume-1; i++){
		TextView volumeText = new TextView(mContext);
		volumeText.setLayoutParams(new LinearLayout.LayoutParams(textWidth,textHeight));
		boxs[i]=volumeText;
		mTextViewGroup.addView(volumeText);	   
	    }
	}

    	for (int i = 0;i <= currentVolume-1;i++){
    	    Log.d("zzzz","set color  "+i+"   boxs[i]"+boxs[i]);
    	    boxs[i].setBackgroundResource(R.drawable.volume_background_checked);
    	}
	for(int i = currentVolume;i<=boxs.length-1;i++){
    	    Log.d("zzzz","set background color  "+i);
	    boxs[i].setBackgroundResource(R.drawable.volume_background);
	    Log.d("zzzz","------");
	}
    }
...
//                setRingerIcon();
	...
	// 	// sc.seekbarView.setEnabled(false);
        ...
        //     }
        // }
	Log.d("zzzz","----mIsAddedView"+mIsAddedView);
    ...
    protected void onRemoteVolumeChanged(int streamType, int flags) {
        ...
        if (((flags & AudioManager.FLAG_SHOW_UI) != 0) || mIsAddedView) {
            synchronized (this) {
	...
	Log.d("zy","resetTimeout");
        removeMessages(MSG_TIMEOUT);
        sendMessageDelayed(obtainMessage(MSG_TIMEOUT), TIMEOUT_DELAY);
    }

    private void forceTimeout() {
	Log.d("zy","forceTimeout");
        removeMessages(MSG_TIMEOUT);
