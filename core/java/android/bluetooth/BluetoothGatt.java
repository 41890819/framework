...
public final class BluetoothGatt implements BluetoothProfile {
    ...
    //tli add
    private Object mAutoConnectFieldLock = new Object();
    ...
    private final IBluetoothGattCallback mBluetoothGattCallback =
        new IBluetoothGattCallback.Stub() {
            ...
            public void onClientRegistered(int status, int clientIf) {
                ...
                try {
                	synchronized (mAutoConnectFieldLock) {
   ...
   /**
    ...
    public boolean discoverServices(ParcelUuid uuid) {
        ...
        try {
            if (uuid != null) {
                mService.discoverServicesByUuid(mClientIf, mDevice.getAddress(), uuid);
            } else {
