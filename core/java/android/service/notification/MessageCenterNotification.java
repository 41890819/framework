 ...
 */
public class MessageCenterNotification implements Parcelable {
     ...
     * @hide */
    @Deprecated
    public MessageCenterNotification(String pkg, int id, String tag, int uid, int initialPid, int score,
    ...
    /** @hide */
    public MessageCenterNotification(String pkg, String basePkg, int id, String tag, int uid,
    ...
    public MessageCenterNotification(Parcel in) {
    ...
    public static final Parcelable.Creator<MessageCenterNotification> CREATOR
            = new Parcelable.Creator<MessageCenterNotification>()
    {
        public MessageCenterNotification createFromParcel(Parcel parcel)
        {
            return new MessageCenterNotification(parcel);
        }

        public MessageCenterNotification[] newArray(int size)
        {
            return new MessageCenterNotification[size];
        }
    };
     ...
     * @hide
     */
    public MessageCenterNotification cloneLight() {
        final Notification no = new Notification();
        this.notification.cloneInto(no, false); // light copy
        return new MessageCenterNotification(this.pkg, this.basePkg,
                this.id, this.tag, this.uid, this.initialPid,
                this.score, no, this.user, this.postTime);
    }

    @Override
    public MessageCenterNotification clone() {
        return new MessageCenterNotification(this.pkg, this.basePkg,
                this.id, this.tag, this.uid, this.initialPid,
    ...
    public String toString() {
        return String.format(
                "MessageCenterNotification(pkg=%s user=%s id=%d tag=%s score=%d: %s)",
